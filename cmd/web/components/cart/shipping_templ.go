...
func ProvinceSelect() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.ResolveAttributeValue(utils.URL("/shipping/address?data=provinces"))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.ResolveAttributeValue(utils.URL("/shipping/quotation"))
		if templ_7745c5c3_Err != nil {
...
func CitySelect() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.ResolveAttributeValue(utils.URL("/shipping/address?data=cities"))
		if templ_7745c5c3_Err != nil {
...
func BarangaySelect() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.ResolveAttributeValue(utils.URL("/shipping/address?data=barangays"))
		if templ_7745c5c3_Err != nil {
...
func input(t string, name string, placeholder string, pattern ...string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(pattern) > 0 {
			...
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.ResolveAttributeValue(pattern[0])
			if templ_7745c5c3_Err != nil {
...
func inputWithClass(t string, name string, placeholder string, class string, pattern ...string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `cart/shipping.templ`, Line: 1, Col: 0}
		}
		...
		if len(pattern) > 0 {
			...
			templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.ResolveAttributeValue(pattern[0])
			if templ_7745c5c3_Err != nil {
...
func infieldLabelInput(t string, name string, label string, value string, pattern ...string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(pattern) > 0 {
			...
			templ_7745c5c3_Var30, templ_7745c5c3_Err = templ.ResolveAttributeValue(pattern[0])
			if templ_7745c5c3_Err != nil {
...
func infieldLabelSelect(id string, name string, label string, required bool, disabled bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var36, templ_7745c5c3_Err = templ.ResolveAttributeValue(required)
		if templ_7745c5c3_Err != nil {
...
func ShippingAddressSelect(prefill models.CartShippingPrefill) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var39, templ_7745c5c3_Err = templ.ResolveAttributeValue(utils.URL("/shipping/quotation"))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var40, templ_7745c5c3_Err = templ.ResolveAttributeValue(prefill.AddressLine2)
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var41, templ_7745c5c3_Err = templ.ResolveAttributeValue(prefill.Postal)
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var42, templ_7745c5c3_Err = templ.ResolveAttributeValue(constants.PatternPostalCode)
		if templ_7745c5c3_Err != nil {
