...
func AdminSuperuserProductsPage(formData models.AdminProductForm) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<style>\n\t\t\t\t.form-section {\n\t\t\t\t\tdisplay: none;\n\t\t\t }\n\t\t\t\t.form-section.active {\n\t\t\t\t\tdisplay: block;\n\t\t\t }\n\t\t\t</style></head><body class=\"bg-cchoicesoft min-h-screen flex flex-col\" _=\"on load call metrics_event('admin_superuser_products_page_visit', '')\"><div class=\"flex-grow p-4\"><div class=\"max-w-4xl mx-auto\"><div class=\"text-center mb-6\"><img src=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
