...
func AddAdminHandlers(s *Server, r chi.Router) {
	...
	r.With(s.requireStaffAuth, s.AllowRoles(enums.STAFF_ROLE_MANAGE_INVOICES, enums.STAFF_ROLE_CREATE_INVOICE)).Get("/admin/invoices/{id}/view", s.adminInvoicesViewHandler)
	r.With(s.requireStaffAuth, s.AllowRoles(enums.STAFF_ROLE_MANAGE_INVOICES, enums.STAFF_ROLE_CREATE_INVOICE)).Get("/admin/invoices/{id}/preview", s.adminInvoicesPreviewModalHandler)
