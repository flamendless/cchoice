...
func NewServer() *ServerInstance {
	...
	newServer.services = Services{
		...
		role:              services.NewRoleService(newServer.encoder, newServer.dbRO, newServer.dbRW, staffLogService),
		staff:             services.NewStaffService(newServer.encoder, newServer.dbRO, newServer.dbRW, staffLogService),
