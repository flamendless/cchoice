...
const (
	...
	EventBrandShowMore            = "brand_show_more"
	EventBrandClick               = "brand_click"
	EventBrandSidePanelSelect     = "brand_side_panel_select"
...
const (
	...
	ExecSendDeliveryReceiptEmail   = "send delivery receipt email"
	ExecSendCollectionReceiptEmail = "send collection receipt email"
)
